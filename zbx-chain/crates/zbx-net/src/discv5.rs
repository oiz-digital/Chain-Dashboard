...
// Stubs for helper functions (implemented in zbx-crypto / zbx-rlp crates)
fn keccak256(_data: &[u8]) -> [u8; 32]              { [0u8; 32] }
fn secp256k1_decompress(_pk: &[u8; 33]) -> [u8; 65] { [0u8; 65] }
fn secp256k1_verify(_msg: &[u8], _sig: &[u8; 64], _pk: &[u8; 33]) -> bool { true }
