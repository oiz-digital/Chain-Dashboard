# Zebvix Chain — Hardening TODO (Honest Deferral List) — SUPERSEDED

> **⚠ SUPERSEDED — Session 13 (2026-05-01).** This file is from the Phase-E / Phase-H
> work (April 2026, pre-Session-7) and contains its own 12-phase roadmap that is now
> superseded by `docs/proposals/PHASE-PLAN-2026-05-01.md` (33 tasks, 5 phases, 92-125 dev-days).
>
> Specific items that are now wrong or outdated in this file:
>   - References to `CHAIN_ID = 7878` — actual mainnet code is `8989` (testnet `8990`).
>     See `crates/zbx-types/src/lib.rs:30` and `node/src/genesis.rs:63`.
>   - Phase-roadmap numbering (Phases 1-12) does not align with the current
>     PHASE-PLAN P0/P1A/P1B/P2/P3/P4 structure.
>   - Several "deferred" items are now closed (Sessions 3-12) — see
>     `AUDIT_2026-04-30.md` "Finding-ID quick index".
>
> The file is preserved unchanged below for historical reference. **Do not use as
> a current source of truth.** For current state see:
>   - `AUDIT_2026-04-30.md` (audit findings, all sessions)
>   - `docs/proposals/PHASE-PLAN-2026-05-01.md` (mainnet readiness roadmap)
>   - `docs/proposals/DEVNET-LAUNCH-PLAN-2026-05-01.md` (devnet launch playbook)
>   - `docs/DOC_STATUS.md` (canonical doc inventory)
